...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<{ params?: object }, { code?: number; message?: string; details?: { "@type"?: string }[] }>({
      path: `/ethdenver-2024/mycelia/mycelia/params`,
      method: "GET",
      ...params,
    });
   ...
   */
  queryRound1Data = (params: RequestParams = {}) =>
    this.request<
      { accumlated_round_1_data?: string },
      { code?: number; message?: string; details?: { "@type"?: string }[] }
    >({
      path: `/ethdenver-2024/mycelia/mycelia/round1data`,
      method: "GET",
      ...params,
    });
   ...
   */
  queryRound2Data = (query?: { identifier?: string }, params: RequestParams = {}) =>
    this.request<
      { accumlated_round_2_data?: string },
      { code?: number; message?: string; details?: { "@type"?: string }[] }
    >({
      path: `/ethdenver-2024/mycelia/mycelia/round2data`,
      method: "GET",
      query: query,
      ...params,
    });
