...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendMsgPostRound1Data({ value, fee, memo }: sendMsgPostRound1DataParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		async sendQueryRound1Data({ value, fee, memo }: sendQueryRound1DataParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		async sendQueryRound2Data({ value, fee, memo }: sendQueryRound2DataParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		async sendQueryRound1DataResponse({ value, fee, memo }: sendQueryRound1DataResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		async sendMsgPostRound2Data({ value, fee, memo }: sendMsgPostRound2DataParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		async sendMsgPostRound1DataResponse({ value, fee, memo }: sendMsgPostRound1DataResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		async sendMsgPostRound2DataResponse({ value, fee, memo }: sendMsgPostRound2DataResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		async sendQueryRound2DataResponse({ value, fee, memo }: sendQueryRound2DataResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
